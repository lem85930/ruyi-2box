...
public class HawkConfig {
   ...
   public static final String CONFIG_URL = "http://192.168.0.100:82/zhuzige.properties";//这个废弃
    ...
    public static final String BASE_URL_ENC = "aHR0cDovL2puY3p5bC50b3A6NzM1NC9ydXlp";//域名加密
